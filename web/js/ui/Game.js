                                     ...
                                     return <div>
                                         ...
                                         <div className="hudPart single">
                                             <div className="hudElm">
                                                 ...
                                                 <div className="value"><input tabIndex="1" type="text" size="5" value={this.state.baseIncome}
                                                                               onChange={this.changeBaseIncome}/></div>
                                             </div>
                                             <div className="hudElm">
                                                 <div className="title">Income tax [%]</div>
                                                 <div className="value"><input tabIndex="1" type="text" size="3" value={this.state.incomeTax}
                                                                               onChange={this.changeIncomeTax}/></div>
                                             </div>
                                             <div className="hudElm">
                                                 <div className="title">Value added tax [%]</div>
                                                 <div className="value"><input tabIndex="1" type="text" size="3" value={this.state.valueAddedTax}
